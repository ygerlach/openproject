  ...
  context "with scrum_projects active", with_flag: { scrum_projects: true } do
    ...
    describe "POST #create" do
      ...
      it "responds with success, creates a sprint, and redirects to backlogs", :aggregate_failures do
        ...
        expect(response.body).to include(sprint_planning_backlogs_project_backlogs_path(project))
    ...
    describe "POST #start" do
      ...
      context "when board creation fails" do
        ...
        it "redirects back to the backlog and leaves the sprint in planning", :aggregate_failures do
          ...
          expect(response).to redirect_to(sprint_planning_backlogs_project_backlogs_path(project))
