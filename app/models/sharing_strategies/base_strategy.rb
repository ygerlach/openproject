...
module SharingStrategies
  class BaseStrategy
    ...
    def available_roles
      ...
      raise SubclassResponsibility, "Override in a subclass and return an array of roles that should be displayed"
    end
    ...
    def manageable?
      raise SubclassResponsibility, "Override in a subclass and return true if the current user can manage sharing"
    end

    def create_contract_class
      raise SubclassResponsibility, "Override in a subclass and return the contract class for creating a share"
    end

    def update_contract_class
      raise SubclassResponsibility, "Override in a subclass and return the contract class for updating a share"
    end

    def delete_contract_class
      raise SubclassResponsibility, "Override in a subclass and return the contract class for deleting a share"
    end

    def share_description(share)
      raise SubclassResponsibility, "Override in a subclass and return a description for the shared user"
    end

    def title
      raise SubclassResponsibility, "Override in a subclass and return a title for the sharing dialog"
    end
